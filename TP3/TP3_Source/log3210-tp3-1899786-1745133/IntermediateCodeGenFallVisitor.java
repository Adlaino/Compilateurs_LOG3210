...
public class IntermediateCodeGenFallVisitor implements ParserVisitor {
    ...
    public Object visit(ASTDeclaration node, Object data) {
        ...
        IntermediateCodeGenFallVisitor.VarType t;
        if(node.getValue().equals("bool")) {
            t = IntermediateCodeGenFallVisitor.VarType.Bool;
        } else {
            t = IntermediateCodeGenFallVisitor.VarType.Number;
        }
    ...
    public Object visit(ASTIfStmt node, Object data) {
        ...
        IntermediateCodeGenFallVisitor.BoolLabel labels = new IntermediateCodeGenFallVisitor.BoolLabel();
        labels.lTrue = null;
    ...
    public Object visit(ASTAssignStmt node, Object data) {
        ...
        if(SymbolTable.get(id) == IntermediateCodeGenFallVisitor.VarType.Number) {
    ...
    public Object visit(ASTBoolExpr node, Object data) {
        IntermediateCodeGenFallVisitor.BoolLabel labels = data != null ? (IntermediateCodeGenFallVisitor.BoolLabel) data : null;
        String tempLabel = null;

        for(int i = 0; i < node.getOps().size(); i++) {
            IntermediateCodeGenFallVisitor.BoolLabel label = new IntermediateCodeGenFallVisitor.BoolLabel();
    ...
    private void genCodeRelTestJump(IntermediateCodeGenFallVisitor.BoolLabel B, String test) {
    ...
    public Object visit(ASTCompExpr node, Object data) {
        if(node.jjtGetNumChildren() == 2) {
            IntermediateCodeGenFallVisitor.BoolLabel labels = (IntermediateCodeGenFallVisitor.BoolLabel) data;
    ...
    public Object visit(ASTNotExpr node, Object data) {
        ...
        if(size % 2 == 1) {
            IntermediateCodeGenFallVisitor.BoolLabel labels = (IntermediateCodeGenFallVisitor.BoolLabel) data;
            IntermediateCodeGenFallVisitor.BoolLabel temp = new IntermediateCodeGenFallVisitor.BoolLabel();
    ...
    public Object visit(ASTIdentifier node, Object data) {
        if(SymbolTable.get(node.getValue()) == IntermediateCodeGenFallVisitor.VarType.Bool) {
            if(data != null) {
                IntermediateCodeGenFallVisitor.BoolLabel labels = (IntermediateCodeGenFallVisitor.BoolLabel) data;
    ...
    //utile surtout pour envoyé de l'informations aux enfants des expressions logiques.
