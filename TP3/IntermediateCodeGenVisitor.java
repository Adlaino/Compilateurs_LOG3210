...
public class IntermediateCodeGenVisitor implements ParserVisitor {
    ...
    public Object visit(ASTDeclaration node, Object data) {
        System.out.println(total_indent+"ASTDeclaration");
        //total_indent+=indent;
    ...
    public Object visit(ASTBlock node, Object data) {
        System.out.println(total_indent+"ASTBlock");
        //total_indent+=indent;
        node.childrenAccept(this, null);
        //total_indent.substring(0,total_indent.length()-indent.length());
        return null;
    ...
    public Object visit(ASTStmt node, Object data) {
        System.out.println(total_indent+"ASTStmt");
        node.childrenAccept(this, data);//nothing to be done here
        return null;
    }
    ...
    public Object visit(ASTIfStmt node, Object data) {
        System.out.println(total_indent+"ASTIfStmt");
        //total_indent+=indent;
        ...
        if(child_num==2){
            ...
            node.jjtGetChild(0).jjtAccept(this, label); m_writer.println(label.lTrue);
            //S1.code
            ...
            //S.code = B.code || label(B.true) ||
            node.jjtGetChild(0).jjtAccept(this,data); toPrint = label.lTrue;
            //S1.code || gen('goto' S.next) ||
            node.jjtGetChild(1).jjtAccept(this, label); m_writer.println("goto "+toPrint);
            //label(B.false) || S2.code
            toPrint = label.lFalse; node.jjtGetChild(2).jjtAccept(this,data);
        }
        return null;
    }
    ...
    public Object visit(ASTWhileStmt node, Object data) {
        System.out.println(total_indent+"ASTWhileStmt");
        node.childrenAccept(this, data);
        return null;
    }

    /*
     *  la difficulté est d'implémenter le "short-circuit" des opérations logiques combine à l'enregistrement des
    ...
    public Object visit(ASTAssignStmt node, Object data) {
        System.out.println(total_indent+"ASTAssignStmt");
    ...
    public Object visit(ASTExpr node, Object data){
        System.out.println(total_indent+"ASTExpr");
    ...
    public String exprCodeGen(SimpleNode node, Object data, Vector<String> ops) {
        System.out.println(total_indent+"exprCodeGen");
        int child = node.jjtGetNumChildren();
        if(child == 1){
    ...
    public Object visit(ASTAddExpr node, Object data) {
        System.out.println(total_indent+"ASTAddExpr");
        return exprCodeGen(node, data, node.getOps());
    }

    @Override
    public Object visit(ASTMulExpr node, Object data) {
        System.out.println(total_indent+"ASTMulExpr");
    ...
    public Object visit(ASTUnaExpr node, Object data) {
        System.out.println(total_indent+"ASTUnaExpr");
    ...
    public Object visit(ASTBoolExpr node, Object data) {
        System.out.println(total_indent+"ASTBoolExpr");
...
//                    if(fall){toPrint = next;}
    ...
    private void genCodeRelTestJump(BoolLabel B, String test) {
        ...
        System.out.println(total_indent+"genCodeRelTestJump");
...
TODO:3. s'il s'agit d'une comparaison de booléen, il faut enregistrer la valeur gauche et droite de la comparaison dans une variable temporaire,
    ...
    public Object visit(ASTCompExpr node, Object data) {
        System.out.println(total_indent+"ASTCompExpr");
        //total_indent+=indent;
        ...
        if(node.jjtGetNumChildren() == 2) {
            ...
            }else//Integer return value
            {
                ...
                genCodeRelTestJump(label, obj1+" "+node.getValue()+" "+obj2+" == 1");
            }
        }
        //total_indent.substring(0,total_indent.length()-indent.length());
        return obj1;
    ...
    public Object visit(ASTNotExpr node, Object data) {
        System.out.println(total_indent+"ASTNotExpr");
        //total_indent+=indent;
    ...
    public Object visit(ASTGenValue node, Object data) {
        System.out.println(total_indent+"ASTGenValue");
        //total_indent+=indent;
        Object tmp = node.jjtGetChild(0).jjtAccept(this, data);
        //total_indent.substring(0,total_indent.length()-indent.length());
        return tmp;
    ...
    public Object visit(ASTBoolValue node, Object data) {
        System.out.println(total_indent+"ASTBoolValue");
        BoolLabel label = new BoolLabel();
        if(node.getValue()){
            previousBool = true;
    ...
    public Object visit(ASTIdentifier node, Object data) {
        System.out.println(total_indent+"ASTIdentifier");
        //total_indent+=indent;
        if(SymbolTable.get(node.getValue()) == VarType.Bool) {
            ...
            label.lTrue = genLabel();
            label.lFalse = genLabel();
            genCodeRelTestJump(label, test);//Higher up functions need to pass a BoolLabel in data
        }
        //total_indent.substring(0,total_indent.length()-indent.length());
    ...
    public Object visit(ASTIntValue node, Object data) {
        System.out.println(total_indent+"ASTIntValue");
